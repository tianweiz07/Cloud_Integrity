...
my_init_module(void)
{
    ...
    nameoffset = (unsigned long)(&(init_net.proc_net->name)) - (unsigned long)(&(*(init_net.
proc_net)));
    nextoffset = (unsigned long)(&(init_net.proc_net->next)) - (unsigned long)(&(*(init_net.
proc_net)));
    dataoffset = (unsigned long)(&(init_net.proc_net->data)) - (unsigned long)(&(*(init_net.
proc_net)));
