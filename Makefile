...
all: $(MODULE_LIST) $(PROCESS_LIST) $(SYSCALL_LIST) $(NET_PORT) $(NET_SOCKET) $(SYSCALL_TRACE) $(SYSCALL_TRACE1)
...
clean:
	$(RM) $(MODULE_LIST) $(PROCESS_LIST) $(SYSCALL_LIST) $(NET_PORT) $(NET_SOCKET) $(SYSCALL_TRACE) $(SYSCALL_TRACE1)
